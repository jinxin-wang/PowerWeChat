...
import (
	...
	"github.com/jinxin-wang/PowerWeChat/v3/src/officialAccount/shakeAround/request"
	"github.com/jinxin-wang/PowerWeChat/v3/src/officialAccount/shakeAround/response"
)
