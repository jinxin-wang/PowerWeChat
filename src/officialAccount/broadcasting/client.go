...
import (
	...
	"github.com/jinxin-wang/PowerWeChat/v3/src/officialAccount/broadcasting/request"
	"github.com/jinxin-wang/PowerWeChat/v3/src/officialAccount/broadcasting/response"
)
