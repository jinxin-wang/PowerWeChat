...
import (
	...
	"github.com/jinxin-wang/PowerWeChat/v3/src/miniProgram/updatableMessage/request"
	"github.com/jinxin-wang/PowerWeChat/v3/src/miniProgram/updatableMessage/response"
)
