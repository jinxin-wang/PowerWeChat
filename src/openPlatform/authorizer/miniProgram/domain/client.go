...
import (
	...
	"github.com/jinxin-wang/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/domain/request"
	"github.com/jinxin-wang/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/domain/response"
)
