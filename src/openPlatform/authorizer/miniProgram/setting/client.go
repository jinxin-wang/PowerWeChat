...
import (
	...
	"github.com/jinxin-wang/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/setting/request"
	"github.com/jinxin-wang/PowerWeChat/v3/src/openPlatform/authorizer/miniProgram/setting/response"
)
