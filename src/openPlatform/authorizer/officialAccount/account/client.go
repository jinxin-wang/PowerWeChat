...
import (
	...
	"github.com/jinxin-wang/PowerWeChat/v3/src/openPlatform/authorizer/aggregate/account"
	"github.com/jinxin-wang/PowerWeChat/v3/src/openPlatform/authorizer/officialAccount/account/response"
)
